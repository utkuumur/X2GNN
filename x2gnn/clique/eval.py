...
def main(args):
    ...
    if not model_path:
        model_path = f'../../models/clique/{dataset}/{dataset}.pt'
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Evaluate MIS model performance with multiple recurrence steps')
    ...
    parser.add_argument('--data_format', type=str, default='networkx', 
                        choices=['numpy', 'networkx'],
