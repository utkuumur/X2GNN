...
def main(args):
    ...
    for epoch in tqdm(range(args.ep)):
        ...
        valid_obj, valid_obj2, valid_obj3, loss, loss_mis, loss_pen, loss_ent, valid_pen, loss_div = eval_iteration(
            model, valid_dataloader, optimizer, scheduler, device, R, p, args.div_coef
        )
...
if __name__ == '__main__':
    ...
    # Model and loss
    parser.add_argument('--target', type=float, default=0.8, help='The probability droping non-hint cells between iterations')
