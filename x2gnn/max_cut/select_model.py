...
def main(args):
    ...
    weights_dir = f'../../models/max_cut/{dataset}/{model_identifier}' if args.model_path == '' else args.model_path
    ...
    phase2_checkpoints = sorted(glob.glob(f'{weights_dir}/weights_second_*.pt'))[-10:]
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Select best checkpoint based on test performance')
    # Model configuration
